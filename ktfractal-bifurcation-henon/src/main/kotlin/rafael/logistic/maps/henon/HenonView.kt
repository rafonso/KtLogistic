...
import rafael.logistic.maps.henon.data.*
import tornadofx.asObservable
import tornadofx.onChange
import tornadofx.runLater
import tornadofx.toProperty

class HenonView : ViewBase<RData, HenonGenerator, BifurcationCanvas>(
    "Henon Canvas",
    "HenonMap",
    HenonGenerator()
) {
    ...
    override fun refreshData(generator: HenonGenerator, iterations: Int): List<RData> =
        if (chart.width > 0) {
            generator.generate(
                spnX1.value,
